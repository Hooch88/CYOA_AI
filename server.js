...
const PromptContextBuilder = require('./prompt-context-builder.js');
...
const apiScope = {
    ...
    prepareBasePromptContext: PromptContextBuilder.buildBasePromptContext,
    players,
    skills,
    things,
    regions,
...
async function startServer() {
    ...
    PromptContextBuilder.initialize({
        config,
        chatHistory: () => chatHistory,
